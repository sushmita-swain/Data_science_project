...
def shut_down():
    p1 = Thread(target=pyttsx3.speak, args=("Shutting down. Thankyou For Using Our Service. Take Care, Good Bye.",))
    p1.start()
...
def web_scraping(qs):
    ...
    canvas2.create_text(10, 10, anchor=NW, text=answer, font=('Candara Light', -25, 'bold italic'), fill='white')
    flag2 = False
    loading.destroy()
...
def wishme():
    ...
    if 0 <= hour < 12:
        text = "Good Morning. I am Maya. How may I help you?"
    elif 12 <= hour < 18:
        text = "Good Afternoon. I am Maya. How may I help you?"
    else:
        text = "Good Evening. I am Maya. How may I help you?"
...
def takecommand():
    ...
    try:
        ...
        query = query.lower()
        canvas2.create_text(490, 120, anchor=NE, justify=RIGHT, text=query, font=('fixedays', -30), fill='white')
        global img3
...
if __name__ == "__main__":
    ...
    img1 = PhotoImage(file='chatbot.gif')
    img2 = PhotoImage(file='download.png')
    img3 = PhotoImage(file='icon.png')
    img4 = PhotoImage(file='background.png')
    background_image = PhotoImage(file='background.png')

    f = Frame(root, width=1360, height=690)
    f.place(x=0, y=0)
    f.tkraise()
    front_image = PhotoImage(file='chatbot.gif')
    okVar = IntVar()
    ...
    frames = [
        PhotoImage('chatbot.gif', format='gif -index %i' % (i))
        for i in range(20)]
